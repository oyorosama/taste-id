                ...
                <div className="text-center mb-10">
                    <Link href="/" className="inline-block">
                        <h1 className="text-4xl font-bold tracking-tight mb-2">
                            Taste<span className="text-[hsl(var(--accent))]">ID</span>
                        </h1>
                    </Link>
                    <p className="text-[hsl(var(--text-muted))]">
                        Your digital fingerprint of taste
                    </p>
                </div>

                <div className="glass p-8 rounded-2xl border border-[hsl(var(--border))]">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 py-3.5 px-4
                                       ...
                                       rounded-xl font-medium transition-colors border border-gray-200"
                        >
