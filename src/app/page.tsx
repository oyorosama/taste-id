        ...
        <main className="min-h-screen flex flex-col items-center justify-center p-8">
            ...
            <div className="text-center max-w-2xl mx-auto animate-fade-in">
                ...
                <p className="text-2xl md:text-3xl font-medium mb-4">
                    Create your Cultural Identity
                </p>
                <p className="text-[hsl(var(--text-muted))] text-lg mb-12 text-balance">
                    Movies, anime, games, books, art — all in one beautiful, swipeable profile.
                    <br />
                    <span className="text-[hsl(var(--text-secondary))]">Share your unique taste with the world.</span>
                </p>
                ...
                <div className="mt-16 flex flex-wrap justify-center gap-3">
                    {["Movies", "Anime", "Games", "Manga", "Books", "Art"].map((category) => (
                        <span
                            key={category}
